...
const GuestNewBooking = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const bookingList = await homestayService.getGuestBookingsByHomestayId(Number(id));
    ...
    const isRoomAvailable = (room: Room) => {
        ...
        return !existingBookings.some(booking => {
            ...
            const hasRoom = booking.rooms.some(bookingRoom => bookingRoom.id === room.id);
                ...
                <div className="p-6">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="bg-gray-50 rounded-lg p-4">
                            ...
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                    Tìm kiếm phòng {newBooking.checkIn && newBooking.checkOut && (
                                        <span className="text-sm font-normal text-green-600">
                                            (có sẵn từ {formatDate(newBooking.checkIn)} đến {formatDate(newBooking.checkOut)})
                                        </span>
                                    )}
                                </label>
