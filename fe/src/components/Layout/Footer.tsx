        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">HomeStay Vietnam</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-emerald-400 transition-colors">Homestay</a></li>
              <li><a href="#" className="text-gray-300 hover:text-emerald-400 transition-colors">Giới thiệu</a></li>
              <li><a href="#" className="text-gray-300 hover:text-emerald-400 transition-colors">Liên hệ</a></li>
              <li><a href="#" className="text-gray-300 hover:text-emerald-400 transition-colors">Hỗ trợ</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-300 text-sm">
              © 2024 HomeStay Vietnam. Tất cả quyền được bảo lưu.
            </div>
